...
SYSTEM = (
    ...
    "applicant whose GPA is below the 3.3 bar for a selective software-engineering "
    "program.\n\n"
    "Rules:\n"
    "- The further the GPA falls below 3.3 (the larger GAP_BELOW_THRESHOLD), the stronger, more "
    "specific, and more realistic the circumstance must be. The bar rises steeply with the gap: "
    "a 3.2 needs a modest, realistic reason; a 2.8 needs a serious, specific circumstance with "
    "a clear causal link to the grades; anything near or below 2.3 requires an exceptional, "
    "concrete, verifiable hardship (severe illness, family crisis, displacement) that plainly "
    "explains the deficit. When in doubt at a large gap, recommend 'reject'.\n"
