...
| Resume | 0–25 | bonus | Task E extracts signals, `config.yaml` prices them — same shape as Tasks C and F. **Disabled** (`resume.bonus_max: 0`) until calibrated. Any failure ⇒ 0 + audit note, never a block. |
